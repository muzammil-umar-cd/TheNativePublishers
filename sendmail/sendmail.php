...
if (isset($_POST['send_reserve_req']) || $_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $service = isset($_POST['service']) ? $_POST['service'] : 'No Service Selected';
  $url = isset($_POST['url']) ? $_POST['url'] : 'None';
  $form = isset($_POST['Form']) ? $_POST['Form'] : 'None';
  ...
  $leads = "INSERT INTO `leads`(`name`, `email`, `phone`, `message`, `service`, `url`, `ip_address`, `city`, `country`, `region`, `zipcode`, `connection`) VALUES ('$name','$email','$phone','$message','','$url','$ip_address','$city','$country','$region','$zipcode','$internet_connection')";
  ...
  $data .= '<tr>
			...
			<tr> 
				<td style="border: 1px solid black; border-collapse: collapse; padding: 15px; text-align: left; font-size:15px; font-weight: 500;">Form<td>
